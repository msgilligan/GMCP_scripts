...
class GLConstantFixer
{
	public static final PACKAGES = [
		'GL11',
		'GL12',
		'GL13',
		'GL14',
	...
	public static final String CALL_REGEX = '(' + PACKAGES.join('|') + /)\.([\w]+)\(.+\)/
	public static final String CONSTANT_REGEX = /(?<![-.\w])\d+(?![.\w])/


	public static String fixOGL(String text)
	{
		// if it never uses openGL, ignore it.
		if (!text.contains("import org.lwjgl.opengl."))
			return text
